...
export default function Voting() {
  ...
  const { runContractFunction: vote } = useWeb3Contract({
    ...
    contractAddress: votingAddress,
    functionName: "vote",
    params: { _candidateId: selectedCandidate },
  });
  ...
  const { runContractFunction: checkVoterAlreadyVotedOrNot } = useWeb3Contract({
    abi: abi,
    contractAddress: votingAddress,
    functionName: "checkVoterAlreadyVotedOrNot",
    params: {},
  });
  const { runContractFunction: getVoterFace } = useWeb3Contract({
    abi: abi,
    contractAddress: votingAddress,
    functionName: "getVoterFace",
    params: {},
  });
