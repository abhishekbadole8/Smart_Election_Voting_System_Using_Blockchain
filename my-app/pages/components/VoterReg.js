...
export default function VoterReg() {
  ...
  const { runContractFunction: getRegistrationStatus } = useWeb3Contract({
    abi: abi,
  ...
  async function sendOTP() {
    ...
    try {
       await fetch(
        "https://api.twilio.com/2010-04-01/Accounts/AC89c24b3cb2ded4463f438338d964299a/Messages.json",
        {
          method: "POST",
          headers: {
            ...
            Authorization:
              "Basic " +
              btoa(
                "AC89c24b3cb2ded4463f438338d964299a:8a8b82e6e0d5de31eaec79a65958a787"
              ),
          },
          body: `Body=Your OTP is ${temppOtp}&From=+16812029943&To=+91${mobileNumber}`,
        }
      );
    } catch (error) {
      console.log(error);
