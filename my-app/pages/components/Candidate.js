...
export default function Candidate() {
  ...
  const { runContractFunction: registerCandidate } = useWeb3Contract({
    abi: abi,
    contractAddress: votingAddress,
    functionName: "registerCandidate",
    params: { _id: ID, _name: name },
  });
  const { runContractFunction: checkCandidateAlreadyRegisteredOrNot } =
    useWeb3Contract({
      abi: abi,
      contractAddress: votingAddress,
      functionName: "checkCandidateAlreadyRegisteredOrNot",
      params: { _id: ID, _name: name },
    });
